    ...
    return (
      <div>
        <Form onSubmit={ this.onSubmit } >
          ...
          <Form.Radio title='Kannada' name='language' selected={true} ref={ (i)=> this.language.kannadaBtn = i } />
          <Form.Radio title='Hindi' name='language' selected={false} ref={ (i)=> this.language.hindiBtn = i }/>
          <Form.Radio title='English' name='language' selected={false} ref={ (i)=> this.language.englishBtn = i }/>
